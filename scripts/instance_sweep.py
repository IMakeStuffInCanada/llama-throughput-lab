...
Matches full_sweep.py behavior exactly, testing: instances (2-16) × parallel (16, 32, 64) × concurrency (16, 32, 64, 128)
"""
...
def main():
    ...
    # CUSTOM RANGES FOR INSTANCE SWEEP
    ...
    results_path = init_results_file("instance_sweep", "instance_sweep")
